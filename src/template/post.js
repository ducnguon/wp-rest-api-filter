...
const renderFilterResult = (response) => {
  ...
  if (response) {
    if (
      ...
      let output =
        '<h2>Search results</h2><div class=""><ul class="js-loop js-el jupiter-donut-clearfix mk-blog-container mk-grid-wrapper jupiter-donut- mag-one-column mk-blog-container-lazyload js-loop--loaded">'
      ...
      let output =
        '<h2>Search results</h2><div class=""><ul class="mk-blog-container mk-thumbnail-wrapper   jupiter-donut- mag-one-column">'
      $j.each(response, function (index, object) {
        output +=
