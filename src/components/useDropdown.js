...
const resetDropdown = () => {
  ...
  if (typeof resetBtn != 'undefined' && resetBtn != null) {
    ...
    resetBtn.addEventListener('click', function (event) {
      ...
      let calendar = $j('.wraf-datepicker')
      calendar.attr('data-before', '')
      calendar.attr('data-after', '')
      const optional_config = {
        dateFormat: 'F d, Y',
        onChange: function (date, str, inst) {
          useDatePicker.onChangeDatePickerField(date, str, inst)
        },
      }
      calendar.flatpickr(optional_config).clear()
    })
  }
}
...
const buildJsonFilterURL = (
  ...
  if (typeof postType != 'undefined' && postType != null) {
    ...
    let datepickerDropdown = document
